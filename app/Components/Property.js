...
function Property() {
  const list= [
    ...
    },
    {
      ...
      description:
        "همواره تلاش می نماییم مناسب ترین قیمت را با کیفیت بالا به مشتریان خود ارائه دهیم",
      icon: qcIcon,
      bgColor: "#FF9800",
    },
    {
    ...
    },
    {
      ...
      description:
        "مجموعه ی ما با پیاده سازی اتوماسیون خاص و منظم خود را متعهد نموده است تا سفارشات را به موقع و با بیشترین سرعت تحویل دهد.",
      icon: sendIcon,
      bgColor: "#009688",
    },
  ];
